...
def MSBD5001_IP(test_size):
	...
	# 选用非0游戏时间的数据来拟合游戏时间
	df_5 = df_4_final[df_4_final['playtime_forever'] > 0]
	...
	save_path='/Users/chenpengyao/Desktop/HKUST/BDT/MSBD_5001_Foundation_of_DA/individual_project/pred_'+str(test_size)+'.csv'
